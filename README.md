...
* @clf Animation issues: make the buttons pop in and out on click
* @clf Animation issues: pet blinks
* @sjg 
...
* @pickUp Make it so that the pet decays when the app is not open
